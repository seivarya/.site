...
---
```
the information on top of the `.astro` file, included n code fences  is called the frontmatter. this data is just 
javascript section.
...
collections stored locally can use build time loaders \[glob(), file()]
to fetch from .md, .mdx, .yaml, .json

or you can use custom build time laoders. i don't think i'll look into
